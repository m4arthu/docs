...
PIX (Sistema de Pagamentos Instantâneos) is Brazil's instant payment system that allows real-time transfers 24/7. PinePay provides a unified API to integrate with multiple PIX gateways, simplifying the complexity of different provider implementations.
...
PinePay supports multiple PIX gateways. Choose the one that best fits your needs:

<CardGroup cols={2}>
<Card title="Woovi" icon="zap">
...
<Card title="EFI" icon="bank">
  **Best for**: Banking integrations
  - Bank-grade security
