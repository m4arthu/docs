...
PinePay sends webhooks for the following events:
...
All webhooks include a signature for verification. Verify the signature to ensure the webhook is from PinePay:
...
1. **Configure Webhook URL**: Set your webhook URL in the PinePay Dashboard
...
PinePay sends the following headers with webhooks:

<ParamField header="Content-Type" type="string">
  Always `application/json`
</ParamField>

<ParamField header="X-PinePay-Signature" type="string">
  HMAC-SHA256 signature for verification
</ParamField>

<ParamField header="X-PinePay-Event" type="string">
  The event type (e.g., `PAYMENT_RECEIVED`)
</ParamField>

<ParamField header="X-PinePay-Delivery" type="string">
