...
const apiClient = axios.create({
  baseURL: 'https://api.braix.com.br',
  headers: {
    'Content-Type': 'application/json'
  }
});
...
response = requests.get('https://api.braix.com.br/transactions', headers=headers)
```
...
curl -X GET "https://api.braix.com.br/transactions" \
...
curl -X GET "https://api.braix.com.br/health" \
  -H "Authorization: Bearer your_access_token_here"
```
</RequestExample>
